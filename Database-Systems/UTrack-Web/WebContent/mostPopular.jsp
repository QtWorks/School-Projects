...
ArrayList<ArrayList<POIRecord>> results = poiService.getTopByCategory(n,1);
session.setAttribute("categoricalResults", results);
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Top <%=n%> Popular Places</title>
</head>
<body>
These are the top <%=n%> most popular places for each category
