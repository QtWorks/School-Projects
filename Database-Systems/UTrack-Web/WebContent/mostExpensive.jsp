...
ArrayList<ArrayList<POIRecord>> results = poiService.getTopByCategory(n,2);
session.setAttribute("categoricalResults", results);
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Top <%=n%> Expensive Places</title>
</head>
<body>
These are the top <%=n%> most expensive places for each category
