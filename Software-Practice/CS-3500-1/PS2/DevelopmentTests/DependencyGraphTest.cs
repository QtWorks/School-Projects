...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        public void NonEmptyTest7()
        {
            ...
            t.ReplaceDependents("a", new HashSet<string>() { "e", "f", "g" });
            HashSet<String> aDents = new HashSet<string>(t.GetDependents("a"));
            Assert.IsTrue(aDents.SetEquals(new HashSet<string>() { "e", "f", "g" }));
            t.ReplaceDependents("t", new HashSet<string>() { "e", "f", "g" });
            HashSet<String> tDents = new HashSet<string>(t.GetDependents("t"));
            Assert.IsTrue(tDents.SetEquals(new HashSet<string>() { "e", "f", "g" }));
        }
        ...
        public void NonEmptyTest8()
        {
            ...
            t.ReplaceDependees("a", new HashSet<string>() { "e", "f", "g" });
            HashSet<String> aDees = new HashSet<string>(t.GetDependees("a"));
            Assert.IsTrue(aDees.SetEquals(new HashSet<string>() { "e", "f", "g" }));
        }
        ...
        public void NonEmptyTest9()
        {
            ...
            t.RemoveAllDependents("a");
            Assert.IsTrue(t.Size == 1);
            t.RemoveAllDependents("d");
        ...
        public void NonEmptyTest10()
        {
            ...
            t.AddDependency("a", "c");
            t.AddDependency("d", "c");
            Assert.IsTrue("c".Equals(t.MostDependedOn()));
            Assert.IsFalse("b".Equals(t.MostDependedOn()));
            Assert.IsTrue("a".Equals(t.MostDependents()));
            Assert.IsFalse("d".Equals(t.MostDependents()));
        }
        ...
        public void NonEmptyTest15()
        {
            ...
            t.AddDependency("a", "c");
            t.AddDependency("d", "c");
            Assert.IsTrue(t.Contains("a", "b"));
            Assert.IsFalse(t.Contains("x", "y"));
            t.RemoveDependency("a", "b");
            Assert.IsFalse(t.Contains("a", "b"));
            t.AddDependency("x", "y");
            Assert.IsTrue(t.Contains("x", "y"));
        }
        // ************************** STRESS TESTS ******************************** //
        /// <summary>
        ///Using lots of data
