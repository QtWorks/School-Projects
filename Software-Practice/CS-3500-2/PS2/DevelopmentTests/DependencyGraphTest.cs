...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        /// Test that my DependencyGraph's Size is working correctly
        /// </summary>
        [TestMethod()]
        public void TestSize()
        {
            ...
            // check initialization is working
            Assert.AreEqual(0, t.Size);
            ...
            // make sure duplicates don't do anything
            t.AddDependency("a", "a");
            Assert.AreEqual(1, t.Size);
            ...
            t.AddDependency("a", "b");
            t.AddDependency("c", "d");
            t.AddDependency("asdfsdaf", "a");
            t.AddDependency("hello", "lol");
            ...
            // make sure removing non-existant pairs doesn't affect anything
            t.RemoveDependency("a", "z");
            Assert.AreEqual(4, t.Size);
        }

        /// <summary>
        /// Test that [] on my DependencyGraph is correctly returning the size of that key's dependees
        /// </summary>
        [TestMethod()]
        ...
        public void TestHasFunctions()
        {
            ...
            // since a is on both sides these should both be true
            Assert.IsTrue(t.HasDependents("a"));
            Assert.IsTrue(t.HasDependees("a"));

            t.AddDependency("a", "b");

            // since b is only a dependee only HasDependees should be true
            Assert.IsFalse(t.HasDependents("b"));
            Assert.IsTrue(t.HasDependees("b"));

            t.AddDependency("c", "a");

            // and for c it is the opposite
