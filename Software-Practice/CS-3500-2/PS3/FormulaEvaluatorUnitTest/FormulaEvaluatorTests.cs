...
{
    /// <summary>
    /// Class to test My Evaluator class
    /// </summary>
    [TestClass]
    public class FormulaEvaluatorTests
    {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static double lookupConsistent(String s)
        {
            return 5;
        }
        ...
        public void Test21()
        {
            Assert.AreEqual(0, Evaluator.Evaluate("xx", s => 0));
        }

        [TestMethod()]
        public void Test22()
        {
            Assert.AreEqual(5, Evaluator.Evaluate("5+xx", s => 0));
        }
