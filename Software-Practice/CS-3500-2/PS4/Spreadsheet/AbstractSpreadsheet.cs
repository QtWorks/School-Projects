...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// <summary>
        /// Recursive method that up the chain of each individual direct dependent trying to find
        /// Circular patterns in your chain
        /// </summary>
        private void Visit(String start, String name, ISet<String> visited, LinkedList<String> changed)
        {
            // adds the one you're currently on to visited
            visited.Add(name);
            // for each direct dependent of name
            foreach (String n in GetDirectDependents(name))
            {
                // this means you've repeated somewhere in your chain
                if (n.Equals(start))
                {
                    throw new CircularException();
                }
                // otherwise, check for the same thing in each of the direct dependents of name again until you've checked them all
                else if (!visited.Contains(n))
                {
                    Visit(start, n, visited, changed);
                }
            }
            // finally, once you know it isn't part of a circular chain
            // you can add it to your changed list as a safe new addition to your
            // spreadsheet
